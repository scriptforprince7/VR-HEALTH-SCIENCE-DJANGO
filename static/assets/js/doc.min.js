    ...
    (APP.docSearch = {
      ...
      eventHandler: function () {
        e(".doc-search-button").on("click", function () {
          APP.docSearch.isFirstRun &&
            (APP.docSearch.loadDocSearch(), (APP.docSearch.isFirstRun = !1)),
          ...
          e(document).on("keydown", function (t) {
            if (
              (t.ctrlKey &&
                t.keyCode === 191 &&
                e(".doc-search-button").trigger("click"),
              (a = e("#doc-search-modal-container")),
              !a.hasClass("visually-hidden"))
            ) {
              var o,
                i,
                a,
                ...
                n = s.find("li.active");
              t.keyCode === 27 && a.addClass("visually-hidden"),
                s.is(":visible") &&
                  (t.keyCode === 38 &&
                    ((o = n.prev()),
                    o.length === 0 && (o = s.find("li:last")),
                    n.removeClass("active"),
                    o.addClass("active"),
                    t.preventDefault()),
                  t.keyCode === 40 &&
                    ((i = n.next()),
                    i.length === 0 && (i = s.find("li:first")),
                    n.removeClass("active"),
                    i.addClass("active"),
                    t.preventDefault()),
                  t.keyCode === 13 &&
        ...
        t.on("keyup", function () {
          ...
          e("#doc-search-modal-container").on("click", function (t) {
            e(t.target).closest(".doc-search-modal").length === 0 &&
              e("#doc-search-modal-container").addClass("visually-hidden");
          });
      },
      getDocPath: function () {
      ...
      excuteSearch: function (t) {
        ...
        if (((t = t.trim()), t === "")) i.show(), n.hide(), o.hide();
          ...
          if (l.length === 0)
            n.hide(), o.show(), e(".doc-search-result-message > span").text(t);
          else {
            n.find("ul").html(""), (a = APP.docSearch.getDocPath());

            for (s in l.slice(0, 10))
              (r = a + l[s].item.permalink),
                (c = l[s].item.description
                  ? "<p>" + l[s].item.description + "</p>"
                  : ""),
                n
                  .find("ul")
                  .append(
            ...
            n
              .find("a > span")
              .append(
                '<svg viewBox="0 0 20 20"><path d="M17 6v12c0 .52-.2 1-1 1H4c-.7 0-1-.33-1-1V2c0-.55.42-1 1-1h8l5 5zM14 8h-3.13c-.51 0-.87-.34-.87-.87V4" stroke="currentColor" fill="none" fill-rule="evenodd" stroke-linejoin="round"></path></svg>'
              ),
              n.show(),
              n.find("li").first().addClass("active"),
              o.hide(),
              e(".doc-search-result-list li").mouseenter(function () {
                e(".doc-search-result-list li").removeClass("active"),
      ...
      loadDocSearch: function () {
        e.ajax({
          ...
          dataType: "json",
          success: function (e) {
            (APP.docSearch.docData = e),
              (APP.docSearch.fuse = new Fuse(e, {
  ...
  (function (e) {
    ...
    (APP.documentation = {
      ...
      docAnchorLink: function () {
        if (
          (e("#docs-toc a").each(function () {
            var n = e(this),
              t = n.attr("href");
            e(t).append('<a class="anchor-link" href="' + t + '"></a>');
          }),
          e(".doc-content").length > 0)
        )
          try {
            var t = location.hash;
