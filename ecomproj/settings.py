...
BASE_URL = 'http://www.vrhealthscience.com/'  # Replace with your actual domain and port
...
ALLOWED_HOSTS = ['127.0.0.1', 'vrhealthscience.com', 'https://vrhealthscience.com/', '192.168.1.21']
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "core.context_processor.defaultThree",
